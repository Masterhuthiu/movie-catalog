...
@AnalyzeClasses(packagesOf = MovieCatalogServiceApp.class, importOptions = DoNotIncludeTests.class)
class TechnicalStructureTest {
    ...
    static final ArchRule respectsTechnicalArchitectureLayers = layeredArchitecture()
        ...
        .ignoreDependency(belongToAnyOf(MovieCatalogServiceApp.class), alwaysTrue())
